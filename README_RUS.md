...
1. [Chapter II](#chapter-ii) \
    2.1. [Part 1. Работа с утилитой cat](#part-1-работа-с-утилитой-cat)  
    2.2. [Part 2. Работа с утилитой grep](#part-2-работа-с-утилитой-grep)  
    2.3. [Part 3. Реализация некоторых флагов утилиты grep](#part-3-реализация-некоторых-флагов-утилиты-grep)  
